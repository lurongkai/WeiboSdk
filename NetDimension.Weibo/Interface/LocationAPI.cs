namespace NetDimension.Weibo.Interface
{
    ...
    internal class LocationAPI : WeiboAPI
    {
        ...
        public string GetMapImage(string center = "", string city = "", string coordinates = "", string names = null,
                                  string offsetX = "", string offsetY = "", string font = "", string lines = "",
                                  string polygons = "", string size = "240×240", string format = "png", string zoom = "",
                                  bool scale = false, bool traffic = false) {
        ...
        public string SearchPOIsByLocation(string q = "", string category = "", string city = "", int page = 1,
                                           int count = 20) {
        ...
        public string SearchPOIsByGeo(string q = "", string category = "", string coordinate = "", string pid = "",
        ...
        public string SearchPOIsByArea(string q = "", string category = "", string coordinates = "", string city = "",
        ...
        public string AddPOI(string srcid, string name, string address, string cityName, string category,
        ...
        public string DriveRouteLine(string beginPID = "", string beginCoordinate = "", string endPID = "",
                                     string endCoordinate = "", int type = 0) {
            return Client.GetCommand("location/line/drive_route",
                                     string.IsNullOrEmpty(beginPID)
                                         ? new WeiboParameter("begin_coordinate", beginCoordinate)
                                         : new WeiboParameter("begin_pid", beginPID),
                                     string.IsNullOrEmpty(endPID)
                                         ? new WeiboParameter("end_coordinate", endCoordinate)
                                         : new WeiboParameter("end_pid", endPID),
                                     new WeiboParameter("type", type));
        }

        public string BusRouteLine(string beginPID = "", string beginCoordinate = "", string endPID = "",
                                   string endCoordinate = "", int type = 0) {
